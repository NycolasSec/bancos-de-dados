...
INSERT INTO livro(nome_livro, isbn_livro, dt_lancamento_livro, num_pagina_livro, fk_autor_livro, fk_editora_livro, fk_genero_livro) VALUES
("Lua Nova", "567678702279", "1950/08/09", 345, 1, 1, 3),
("A terra do nunca", "9788533302273", "1989/07/08", 76, 2, 4, 3),
("O sol nascente", "5647678602273", "1999/05/21", 256, 1, 4, 3),
("O anão", "56464802278", "2001/11/13", 45, 4, 4, 3),
("A corda", "67834802458", "2001/01/06", 78, 3, 1, 4),
("A corda bamba", "4563554298", "1978/12/13", 98, 2, 1, 4),
("Senhor do mundo", "6563554290", "1984/05/12", 256, 1, 1, 4),
("Os dois mundos", "3547654290", "2005/03/06", 98, 4, 1, 4),
("O laptop", "1443454290", "1899/08/31", 145, 3, 2, 2),
("Código Davinci", "47544856870", "1978/05/09", 346, 2, 2, 2),
("Davi o grande rei", "13235487360", "2007/09/12", 76, 1, 2, 2),
("A escola amaldiçoada", "16535454360", "2001/10/11", 457, 4, 2, 2),
("Afreira", "16535454369", "2012/10/09", 289, 3, 3, 1),
("A casa branca", "78544854369", "2004/07/21", 190, 2, 3, 1),
("A escola negra", "25446754368", "2009/02/13", 120, 4, 3, 1),
("A caixa amaldiçoada", "46675714368", "1983/09/07", 678, 1, 3, 1);
